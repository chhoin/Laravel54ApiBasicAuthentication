...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 07, 2017 at 10:38 AM
...
(4, '2013_05_22_122915_create_tbl_statuses_table', 1),
...
CREATE TABLE `tbl_statuses` (
  ...
  `status_author` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ADMIN',
...
(1, 'ACTIVE', 'This is Active', '1', 'ADMIN', '1', '2017-07-06 17:00:00', NULL),
(2, 'DELETE', 'This is delete', '1', 'ADMIN', '1', '2017-07-06 17:00:00', NULL),
(3, 'CANCEL', 'This is Cancel', '1', 'ADMIN', '1', '2017-07-06 17:00:00', NULL),
(4, 'PENDING', 'This is pending', '1', 'ADMIN', '1', '2017-07-06 17:00:00', NULL);
...
(1, 'Admin', 'admin@gmail.com', '$2y$10$oO1KmcPvGRWJY.hRbKDptedfw1AI9FD.HLDfOS7pZPndkHEXNfsSu', NULL, '2017-07-06 17:00:00', NULL);
